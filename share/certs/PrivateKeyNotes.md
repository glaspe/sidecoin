...
unlocked to sign the Sidecoin-Qt.app bundle.
...
allowing somebody to distribute a Sidecoin-Qt.app or sidecoin-qt-setup.exe with a valid
...
that the sidecoin-qt.exe file inside the installer had not been tampered with.
