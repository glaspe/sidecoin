...
unlocked to sign the Scarycoin-Qt.app bundle.
...
allowing somebody to distribute a Scarycoin-Qt.app or scarycoin-qt-setup.exe with a valid
...
that the scarycoin-qt.exe file inside the installer had not been tampered with.
