The following is a list of assets used in the scarycoin source and their proper attribution.
...
* License: MIT
* Site: [https://scarycointalk.org/index.php?topic=15276.0](https://scarycointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original scarycoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/scarycoin.icns, src/qt/res/src/scarycoin.svg,
	src/qt/res/src/scarycoin.ico, src/qt/res/src/scarycoin.png,
	src/qt/res/src/scarycoin_testnet.png, docs/scarycoin_logo_doxygen.png,
