Sidecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/sidecoin/files/Sidecoin/sidecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Sidecoin
...
New/changed settings (command-line or sidecoin.conf file)
--------------------------------------------------------
