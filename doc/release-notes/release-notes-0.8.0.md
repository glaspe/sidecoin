Scarycoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/scarycoin/files/Scarycoin/scarycoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Scarycoin
...
New/changed settings (command-line or scarycoin.conf file)
--------------------------------------------------------
