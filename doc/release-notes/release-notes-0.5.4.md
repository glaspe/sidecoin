Sidecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/sidecoin/files/Sidecoin/sidecoin-0.5.4/
...
http://gitorious.org/sidecoin/sidecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Sidecoin-Qt notifications under Growl 1.3.
Increase required age of Sidecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSidecoin properly when installing Sidecoin-Qt over it. (Windows)
