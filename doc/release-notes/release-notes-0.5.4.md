Scarycoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/scarycoin/files/Scarycoin/scarycoin-0.5.4/
...
http://gitorious.org/scarycoin/scarycoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Scarycoin-Qt notifications under Growl 1.3.
Increase required age of Scarycoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxScarycoin properly when installing Scarycoin-Qt over it. (Windows)
