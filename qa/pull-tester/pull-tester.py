...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old ScarycoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/ScarycoindComparisonTool_jar/ScarycoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/scarycoin/scarycoin.git")
...
environ_default("BUILD_PATH", "/mnt/scarycoin")
...
environ_default("GITHUB_REPO", "scarycoin/scarycoin")
