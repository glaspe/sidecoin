...
#ifndef _SIDECOINRPC_CLIENT_H_
#define _SIDECOINRPC_CLIENT_H_ 1
...
/** Show help message for sidecoin-cli.
 ...
 *
 * @note the argument can be removed once sidecoin-cli functionality is removed from sidecoind
 */
