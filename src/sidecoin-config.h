/* src/sidecoin-config.h.  Generated from sidecoin-config.h.in by configure.  */
/* src/sidecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SIDECOIN_CONFIG_H

#define SIDECOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@sidecoin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sidecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sidecoin Core 0.9.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sidecoin"
